		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Team Marvel",
									"targetURL": "#comsapteammarvelhub-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapteammarvelhub-display": {
								"semanticObject": "comsapteammarvelhub",
								"action": "display",
								"description": "A Fiori application. the application contains of the live stocks values and team data and some news",
								"title": "Team Marvel",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.teammarvelhub",
									"url": sap.ui.require.toUrl("com/sap/teammarvelhub")
								}
							}
						}
					}
